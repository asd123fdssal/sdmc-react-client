...
export function GameDetailPage(){
	...
	return (
				...
				<div className="space-align-container" style={{width:"100%"}}>
					<div className="space-align-block" style={{width:"100%"}}>
						<Space align="center" style={{padding:"12px 8px 12px 8px"}}>
							<Button style={{paddingRight:"12px"}} onClick={(e) => {navigate('/games/upload')}} type="primary" icon={<AiOutlineUserAdd />} size={"middle"}>
								캐릭터 추가
							</Button>
		...
		>
			<div style={{width:"100%"}}>
				<div className="space-align-container" style={{wordWrap:"break-word", width:"100%"}}>
					<div className="space-align-block" style={{width:"100%"}}>
						<Space align="center" style={{padding:"12px 8px 12px 8px"}}>
							<Button style={{paddingRight:"12px"}} onClick={(e) => {navigate('/games/upload')}} type="primary" icon={<AiOutlineUserAdd />} size={"middle"}>
								캐릭터 추가
